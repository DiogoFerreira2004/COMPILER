...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    private List<AnalysisPass> buildPasses(SymbolTable table) {
        List<AnalysisPass> passes = new ArrayList<>();

        passes.add(new UndeclaredVariable());
        passes.add(new ObjectAssignmentCheck());
        passes.add(new OperationTypeCheck());
        passes.add(new ControlFlowCheck());
        passes.add(new ArrayAccessCheck());
        passes.add(new ReturnTypeCheck());
        passes.add(new MethodCallCheck());
        passes.add(new MethodDeclarationCheck());
        passes.add(new ScopeViolationCheck());
        passes.add(new ImportedMethodUseCheck());
